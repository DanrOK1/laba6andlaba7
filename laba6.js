...
var Car = function () {
    ...
    var Car = _classThis = /** @class */ (function () {
        function Car_1(brand, model) {
            this.brand = (__runInitializers(this, _instanceExtraInitializers), brand);
            this.model = model;
        }
        Car_1.prototype.getInfo = function () {
            return "\u041C\u0430\u0440\u043A\u0430: ".concat(this.brand, ", \u041C\u043E\u0434\u0435\u043B\u044C: ").concat(this.model);
        };
        return Car_1;
    }());
    ...
    (function () {
        ...
        _getInfo_decorators = [toUpperCase];
